...
#define NTY_PROTO_VOICE_DATA_REQ_OFFLINEMSGID_IDX	(NTY_PROTO_VOICE_DATA_REQ_PKTLENGTH_IDX+2)
...
#define NTY_PROTO_OFFLINE_MSG_ACK_JSON_LENGTH_IDX		(NTY_PROTO_OFFLINE_MSG_ACK_STATUS_IDX+NTY_DEVID_LENGTH)
...
#define NTY_PROTO_BIND_CONFIRM_PUSH_RSVD_IDX				(NTY_PROTO_BIND_CONFIRM_PUSH_DEVICEID_IDX+NTY_DEVID_LENGTH)
#define NTY_PROTO_BIND_CONFIRM_PUSH_JSON_LENGTH_IDX			(NTY_PROTO_BIND_CONFIRM_PUSH_RSVD_IDX+NTY_ACKNUM_LENGTH)
