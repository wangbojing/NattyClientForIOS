...
#define NTY_PROTO_VERSION				NTY_PROTO_VERSION_B
...
#define NTY_PROTO_SELFTYPE				NTY_PROTO_CLIENT_IOS
...
#define NTY_PROTO_MSG_PUSH_DEVID_IDX					NTY_PROTO_DEVID_IDX
#define NTY_PROTO_MSG_PUSH_RSVD_IDX						(NTY_PROTO_MSG_PUSH_DEVID_IDX+NTY_DEVID_LENGTH)
#define NTY_PROTO_MSG_PUSH_RECVID_IDX					(NTY_PROTO_MSG_PUSH_RSVD_IDX+4)
#define NTY_PROTO_MSG_PUSH_JSON_LENGTH_IDX				(NTY_PROTO_MSG_PUSH_RECVID_IDX+NTY_DEVID_LENGTH)
#define NTY_PROTO_MSG_PUSH_JSON_CONTENT_IDX				(NTY_PROTO_MSG_PUSH_JSON_LENGTH_IDX+2)


#define NTY_PROTO_PERFORMANCE_PACKET_REQ_DEVICEID_IDX			NTY_PROTO_DEVID_IDX
#define NTY_PROTO_PERFORMANCE_PACKET_REQ_JSON_LENGTH_IDX		(NTY_PROTO_USERDATA_PACKET_REQ_DEVICEID_IDX+NTY_DEVID_LENGTH)
#define NTY_PROTO_PERFORMANCE_PACKET_REQ_JSON_CONTENT_IDX		(NTY_PROTO_USERDATA_PACKET_REQ_JSON_LENGTH_IDX+2)
...
#define NTY_PROTO_PERFORMANCE_REQ 			0x50
#define NTY_PROTO_PERFORMANCE_ACK			0xD0
